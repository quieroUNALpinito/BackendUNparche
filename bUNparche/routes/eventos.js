...
router.post('/consultarAsistentesEvento',eventController.consultarAsistentesEvento)
...
router.post('/actualizarNotificaciones',eventController.actualizarNotificaciones)
